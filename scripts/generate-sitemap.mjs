...
const staticUrls = [
  ...
  { path: "/technology/zaftys-tms", priority: "0.9", changefreq: "weekly", lastmod: today },
  { path: "/technology/fleet-management", priority: "0.8", changefreq: "monthly", lastmod: today },
  { path: "/technology/tracking", priority: "0.8", changefreq: "monthly", lastmod: today },
  { path: "/technology/apis", priority: "0.8", changefreq: "monthly", lastmod: today },
