...
export const cookieSections: LegalSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Where enabled, help understand visitors, pages viewed, traffic sources, campaigns, button clicks and form completions. Website analytics may use Google Analytics 4 and Microsoft Clarity, configured in line with applicable privacy requirements. Separately, the ZAFTYS hosting server may record the exact IP address and pages viewed for security and traffic measurement even if analytics cookies are blocked. Approximate city, region and ISP may be derived from that IP via a geolocation lookup. That server log is described in the Privacy Policy and is deleted from hosting after 90 days.",
      },
      {
        type: "h3",
