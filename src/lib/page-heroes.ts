...
export const pageHeroAlts = {
  about: "ZAFTYS industrial logistics heritage — heavy freight operations in India",
  careers: "ZAFTYS logistics and technology careers in Amravati",
  contact: "Contact ZAFTYS for industrial freight quotes in India",
  fleet: "ZAFTYS company-operated heavy-haul fleet on an industrial corridor",
