...
export const industries: readonly IndustryRecord[] = [
  {
    ...
    serviceLinks: [
      { label: "Industrial Freight", path: "/logistics#industrial" },
      { label: "Contract Logistics", path: "/logistics#contract" },
    ],
  ...
  },
  {
    ...
    serviceLinks: [
      { label: "Industrial Freight", path: "/logistics#industrial" },
      { label: "Dedicated Fleet", path: "/logistics#dedicated" },
    ],
  ...
  },
  {
    ...
    serviceLinks: [
      { label: "Industrial Freight", path: "/logistics#industrial" },
      { label: "3PL Transportation", path: "/logistics#three-pl" },
    ],
  ...
  },
  {
    ...
    serviceLinks: [
      { label: "Container Transportation", path: "/logistics#container" },
      { label: "3PL Transportation", path: "/logistics#three-pl" },
    ],
