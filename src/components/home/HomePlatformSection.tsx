...
export function HomePlatformSection() {
  ...
  return (
    <section id="platform" aria-labelledby="platform-heading">
      <div className="section-padding bg-white pb-8">
        <div className="container mx-auto container-padding">
          <div className="text-center max-w-3xl mx-auto">
            <p className="text-sm font-semibold uppercase tracking-widest text-primary mb-3">{platform.eyebrow}</p>
        ...
        <div className="container mx-auto container-padding">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="lg:w-1/2 order-1 lg:order-2">
              ...
              <h3 id="platform-tms-heading" className="text-3xl md:text-4xl font-heading font-bold mb-4 text-navy leading-tight">
                {platform.tms.h3}
              </h3>
      ...
      <div className="section-padding bg-navy text-white" aria-labelledby="platform-tranzfort-heading">
        <div className="container mx-auto container-padding">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <div className="lg:w-1/2">
              <div className="inline-block px-3 py-1 rounded-full bg-accent/20 border border-accent/30 text-accent text-sm font-semibold mb-4 uppercase tracking-widest">
                {platform.tranzfort.badge}
              </div>
              <h3 id="platform-tranzfort-heading" className="text-3xl md:text-4xl font-heading font-bold mb-4 leading-tight">
                {platform.tranzfort.h3}
              </h3>
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">{platform.tranzfort.lead}</p>
              <CTAGroup className="justify-start">
                ...
                <Link to={paths.network.tranzfort}>
                  <Button variant="on-dark-outline">How Tranzfort works</Button>
                </Link>
              </CTAGroup>
            </div>
