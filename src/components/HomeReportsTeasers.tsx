...
export default function HomeReportsTeasers() {
  const reports = latestReports(6);
  ...
  return (
    <section className="py-12 bg-muted/30" aria-labelledby="home-reports-heading">
      ...
      <div className="relative overflow-hidden">
        <div
          className="pointer-events-none absolute inset-y-0 left-0 z-10 w-8 sm:w-16 bg-gradient-to-r from-muted/30 to-transparent"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute inset-y-0 right-0 z-10 w-8 sm:w-16 bg-gradient-to-l from-muted/30 to-transparent"
          aria-hidden
        />
