-- Deployed under public/config/migrations/ (HTTP blocked).
-- Applied by POST /api/migrate.php with MIGRATE_TOKEN.
-- Easy-mode v1: newsletter.php inserts status = 'active'.
