...
export default async function BillingGstPage() {
  const s = await getGstSummary();
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="font-semibold text-navy">{s.taxableValue}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="font-semibold text-navy">{s.igst}</p>
          </CardContent>
        </Card>
      </div>
      <DataTable
        ...
        columns={[
          ...
          { key: "due", header: "Due date", render: (r) => r.due },
          {
            key: "status",
            header: "Status",
            render: (r) => <StatusPill status={r.status} map={filingStatus} />,
          },
        ]}
      />
    </>
